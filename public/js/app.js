...
const tracks = [
  ...
  },
  {
    ...
    artist:"J.Cole",
    year:2019,
    file:"/J. Cole - Middle Child (Clean).mp3"
  },
  {
    name:'Wow',
    length:song.duration / 60,
    artist:"Post Malone",
    year:2019,
    file:"/Post Malone - Wow. [Clean Version] - Clean Muzic.mp3"
  },
  {
    ...
    artist:"Maroon 5",
    year:2019,
    file:"/Maroon 5 - Girls Like You (Clean - Lyrics) ft. Cardi B.mp3"
  },
  {
    ...
    artist:"Meek Mill",
    year:2019,
    file:"/Meek Mil - Going Bad (Clean) ft. Drake.mp3"
  },{
    name:'Undecided',
    length:'0:00',
    artist:"Chris Brown",
    year:2019,
    file:"/Chris Brown - Undecided (Official Lyrics).mp3"
  },{
    name:'Happier ft Bastille',
    length:'0:00',
    artist:"Marshmello",
    year:2019,
    file:"/Marshmello ft. Bastille - Happier (Official Music Video).mp3"
  },{
    name:'Alot ft J.Cole',
    length:'0:00',
    artist:"21 Savage",
    year:2019,
    file:"/21 Savage - a lot (Clean).mp3"
  },{
    name:'7 Years',
    length:'0:00',
    artist:"Lucas Graham",
    year:2019,
    file:"/Lukas Graham -  7 Years [OFFICIAL MUSIC VIDEO].mp3"
  }
]
